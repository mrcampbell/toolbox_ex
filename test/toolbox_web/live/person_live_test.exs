defmodule MCWeb.PersonLiveTest do
  use MCWeb.ConnCase

  import Phoenix.LiveViewTest
  import MC.FormFixtures

  @create_attrs %{name: "some name", lucky_number: 42, birthday: "2023-07-27"}
  @update_attrs %{name: "some updated name", lucky_number: 43, birthday: "2023-07-28"}
